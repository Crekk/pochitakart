...
def update():
    ...
    if held_keys['s']:
        # braking! reduce speed strongly toward 0
        brake_strength = 10
        if speed > 0:
    ...
    if turn_input:
        drift_modifier = 1.0
        if held_keys['shift']:
            drift_modifier = 2.0   # or try 2.5 for even sharper drift
